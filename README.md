...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - image: registry.aliyuncs.com/acs/kube-eventer-amd64:v1.1.0-03a3e2b-aliyun
          name: kube-eventer
          command:
            - "/kube-eventer"
...
| <a href="docs/en/mysql-sink.md">log</a>               | sink to mysql database           |
| <a href="docs/en/wechat-sink.md">log</a>               | sink to wechat           |
